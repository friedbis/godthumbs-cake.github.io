...
basedir=$(dirname $0)/..
rssurl="https://www.ladyeve.net/feed||http://newmofu.doorblog.jp/rss/adult.xml||http://vipsister23.com/index.rdf||https://news.yahoo.co.jp/rss/topics/top-picks.xml||http://2ch-c.net/feed/?t=show"
...
find $destdir -mtime +15 -exec rm -v {} \;
#rm -f $destdir/*.md
#git rm $destdir/*.md
echo "deleted"
mkdir -p $destdir
